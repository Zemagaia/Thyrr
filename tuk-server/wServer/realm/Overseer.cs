...
using Castle = wServer.realm.worlds.logic.Castle;
...
namespace wServer.realm
{
    ...
    public class Overseer
    {
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(Overseer));
        ...
        public Overseer(World world, string worldName)
        {
            ...
            world.Manager.Resources.Worlds.TauntData.TryGetValue(worldName, out _tauntData);
            world.Manager.Resources.Worlds.SpawnData.TryGetValue(worldName, out _spawnData);
            world.Manager.Resources.Worlds.EventData.TryGetValue(worldName, out _eventData);
        }
        ...
        private void SpawnEvent(string name, string setpiece)
        {
            ...
            Log.InfoFormat("{0}: {1} has been spawned at ({2}, {3})", _world.GetDisplayName(), name, pt.X, pt.Y);
        }

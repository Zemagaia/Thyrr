...
namespace wServer.logic.loot
{
    ...
    public class TierLoot : ILootDef
    {
            ...
            Random rand, IList<LootDef> lootDefs)
        {
            ...
            foreach (var i in candidates)
                lootDefs.Add(new LootDef(ItemData.GenerateData(i.ObjectType), _probability / candidates.Length));
        }
    }

    public class ItemLoot : ILootDef
    {
        protected static readonly ILog Log = LogManager.GetLogger(typeof(ItemLoot));
    ...
    {
        protected static readonly ILog Log = LogManager.GetLogger(typeof(QuestLoot));
        private readonly string _item;
        private readonly double _probability;

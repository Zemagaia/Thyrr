...
namespace GameServer.networking.server
{
    ...
    public class Server
    {
        static readonly Logger Log = LogUtil.GetLogger(typeof(Server));
        ...
        public Server(RealmManager manager, int port, int maxConnections,
            byte[] clientKey) // think about making a settings class...
        {

...
namespace GameServer.realm.entities
{
    partial class Player
    {
        ...
        public void SendError(string text, params object[] args)
        {
            _client.SendPacket(new Text()
            {
                BubbleTime = 0,
        ...
        public void SendClientText(string text, params object[] args)
        {
            _client.SendPacket(new Text()
            {
                BubbleTime = 0,
        ...
        public void SendHelp(string text, params object[] args)
        {
            _client.SendPacket(new Text()
            {
                BubbleTime = 0,
        ...
        public void SendEnemy(string name, string text, int nameColor = -1)
        {
            _client.SendPacket(new Text()
            {
                BubbleTime = 0,
                ...
                Name = name,
                Txt = text,
                NameColor = nameColor == -1 ? 0xFFA800 : nameColor
            });
        }
        ...
        public void SendEnemy(string name, string text, params object[] args)
        {
            _client.SendPacket(new Text()
            {
                BubbleTime = 0,
        ...
        internal void Invited(int objId, string inviter, string dungeon)
        {
            _client.SendPacket(new Text()
            {
                ...
                NumStars = -1,
                Name = "",
                Txt = "You've been invited by " + inviter + " to join them in " + dungeon + ". Send /daccept " + objId +
                      " to join.",
                TextColor = 0x94b8b8
            });
        }

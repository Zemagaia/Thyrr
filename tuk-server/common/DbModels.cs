...
namespace common
{
    ...
    public class DbAccount : RedisObject
    {
        ...
        public ItemData[] Gifts
        {
            get => GetValue("gifts", new ItemData[0]);
    ...
    public abstract class RInventory : RedisObject
    {
        ...
        public ItemData[] Items
        {
            get => GetValue(Field, new ItemData[20].Select(_ => new ItemData()).ToArray());
    ...
    public class DbVaultSingle : RInventory
    {
        public DbVaultSingle(DbAccount acc, int vaultIndex)
        {
            ...
            SetValue(Field, Utils.ResizeArray(Items, 8));
            FlushAsync(trans);

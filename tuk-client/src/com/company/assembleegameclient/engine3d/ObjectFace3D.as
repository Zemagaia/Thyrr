...
public class ObjectFace3D {
    ...
    {
        var _local4:int;
        var _local5:int = (this.indices_[0] * 2);
        var _local6:int = (this.indices_[1] * 2);
        var _local7:int = (this.indices_[(this.indices_.length - 1)] * 2);
        var _local8:Vector.<Number> = this.obj_.vS_;
        var _local9:Number = (_local8[_local6] - _local8[_local5]);
        var _local10:Number = (_local8[(_local6 + 1)] - _local8[(_local5 + 1)]);
        var _local11:Number = (_local8[_local7] - _local8[_local5]);
        var _local12:Number = (_local8[(_local7 + 1)] - _local8[(_local5 + 1)]);
        if (((_local9 * _local12) - (_local10 * _local11)) < 0)
        {
            return;
        }
        ...
        var _local13:int;
        while (_local13 < this.indices_.length)
        {
            _local4 = this.indices_[_local13];
            this.path_.data[(_local13 * 2)] = _local8[(_local4 * 2)];
            this.path_.data[((_local13 * 2) + 1)] = _local8[((_local4 * 2) + 1)];
            _local13++;
        }

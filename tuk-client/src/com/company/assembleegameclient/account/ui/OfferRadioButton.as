...
public class OfferRadioButton extends Sprite implements Selectable {
    ...
    private function makeCoinImage():void {
        this.coinBitmap = AssetLibrary.getImageFromSet("interfaceSmall", 81);
    ...
    private function makeGoldText():void {
        ...
        this.goldText.setStringBuilder(new LineBuilder().setParams("{amount} Gold", {"amount": this.offer.realmGold_}));
    ...
    private function makeBonusText():void {
        ...
        this.bonusText.setStringBuilder(new LineBuilder().setParams("{percent}% Bonus", {"percent": this.offer.bonus}));

...
public class TradeInventory extends Sprite {
    ...
    public function TradeInventory(_arg1:GameSprite, _arg2:String, _arg3:Vector.<TradeItem>, _arg4:Boolean) {
        ...
        this.nameText_ = new BaseSimpleText(22, 0xB3B3B3, false, 0, 0);
        this.nameText_.setBold(true);
        this.nameText_.x = 0;
        this.nameText_.y = 5;
        this.nameText_.text = this.playerName_;
        this.nameText_.updateMetrics();
        this.nameText_.filters = FilterUtil.getWeakOutlineFilter();
        addChild(this.nameText_);
        this.taglineText_ = new TextFieldDisplayConcrete().setSize(14).setColor(0xB3B3B3);

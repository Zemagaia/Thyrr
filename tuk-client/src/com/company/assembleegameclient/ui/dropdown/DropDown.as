...
public class DropDown extends Sprite {
    ...
    public function DropDown(strings:Vector.<String>, w:int, h:int, labelText:String = null, index:Number = 0, maxItems:int = 17) {
        ...
        if (labelText != null) {
            ...
            this.labelText_.text = (labelText + ":");

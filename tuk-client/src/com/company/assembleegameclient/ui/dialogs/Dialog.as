...
public class Dialog extends Sprite {
    ...
    public function Dialog(title:String, text:String, leftButton:String, rightButton:String, replaceTokens:Object = null, background:Boolean = false)
    {
    ...
    private function _makeUIAndAdd(title:String, text:String):void {
        this.initText(text);

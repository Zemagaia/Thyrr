...
public class TOSPopup extends Sprite {
    ...
    protected function initText():void {
        ...
        var _local1:LineBuilder = new LineBuilder().setParams("Our Privacy Policy, Terms of Service, and End User License Agreement have changed.\n\n\nView changes:");
    ...
    protected function initText2():void {
        ...
        var _local3:LineBuilder = new LineBuilder().setParams("{policy}Privacy Policy{_policy}\n\n{tou}Terms of Service & EULA{_tou}", {
            "tou": _local1,
            "_tou": "</a></font>",
            "policy": _local2,
            "_policy": "</a></font>"
    ...
    private function makeButton():void {
        this.buttonAccept = new DeprecatedTextButton(16, "Accept");

...
public class ChoiceBox extends Sprite {
    ...
    private var internalFill_:GraphicsSolidFill = new GraphicsSolidFill(0x2B2B2B, 1);
    private var overLineFill_:GraphicsSolidFill = new GraphicsSolidFill(0x545454, 1);
    private var normalLineFill_:GraphicsSolidFill = new GraphicsSolidFill(0x7B7B7B, 1);

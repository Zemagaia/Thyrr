...
public class ClassToolTip extends ToolTip {
    ...
    public function ClassToolTip(_arg1:XML, _arg2:PlayerModel, _arg3:CharacterStats) {
        ...
        this.lineBreak_ = new LineBreakDesign(width, 0x7B7B7B);
        this.lineBreak_.x = -6;
        ...
        if (this.showUnlockRequirements) {
            ...
            this.toUnlockText_.setStringBuilder(new LineBuilder().setParams("To Unlock:"));
            ...
            for each (_local9 in _arg1.UnlockLevel) {
                ...
                if (_arg2.getBestLevel(_local11) < int(_local9.@level)) {
                    _local8.pushParams2("Reach Level {unlockLevel} with {typeToDisplay}", {
            ...
            if (_local14 > 0) {
                ...
                this.nextClassQuest_.setStringBuilder(new LineBuilder().setParams("Next Goal: Earn {nextStarFame} Fame with {typeToDisplay}", {
    ...
    override protected function alignUI():void {
        ...
        this.descriptionText_.y = 36;
        this.lineBreak_.x = -6;
        this.lineBreak_.y = height;
        if (this.showUnlockRequirements) {
            this.toUnlockText_.x = 4;
    ...
    override public function draw():void {
        this.lineBreak_.setLengthColor((width), 0x7B7B7B, false);
        super.draw();
    }

...
public class Camera {
    ...
    public static var MapRectFSCentered:Rectangle;
    public static var MapRectFSNonCentered:Rectangle;
    ...
    public function configureCamera(_arg1:GameObject, _arg2:Boolean):void {
        var _local3:Rectangle = this.correctViewingArea(Parameters.data_.centerOnPlayer);

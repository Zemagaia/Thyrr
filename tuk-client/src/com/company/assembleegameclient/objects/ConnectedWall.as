...
public class ConnectedWall extends ConnectedObject
{
    ...
    protected function addQuad(_arg1:Vector3D, _arg2:Vector3D, _arg3:Vector3D, _arg4:Vector3D, _arg5:BitmapData, _arg6:Boolean, _arg7:Boolean):void
    {
        ...
        var _local11:int = int((obj3D_.vL_.length / 3));
        obj3D_.vL_.push(_arg1.x, _arg1.y, _arg1.z, _arg2.x, _arg2.y, _arg2.z, _arg3.x, _arg3.y, _arg3.z, _arg4.x, _arg4.y, _arg4.z);
        var _local12:Number = ((!(_arg6)) ? Number(0) : Number((-(this.bI_ - this.tI_) / ((1 - (this.bI_ - this.tI_)) - ((!(_arg7)) ? 0 : (this.bI_ - this.tI_))))));
        obj3D_.uvts_.push(0, 0, 0, 1, 0, 0, 1, 1, 0, _local12, 1, 0);
        var _local13:ObjectFace3D = new ObjectFace3D(obj3D_, new <int>[_local11, (_local11 + 1), (_local11 + 2), (_local11 + 3)]);
        _local13.texture_ = _arg5;
        _local13.bitmapFill_.repeat = this.wallRepeat_;
        obj3D_.faces_.push(_local13);
        if (((GraphicsFillExtra.getVertexBuffer(_local13.bitmapFill_) == null) && (Parameters.isGpuRender())))
        {
            _local8 = 0;
            _local9 = 0;
            if (_arg6)
            ...
            if (((((_local9 == 0) && (_local8 == 0)) && (_arg7)) && (_arg4.x == -0.5)))
            {
                _local9 = 0.34;
            }
            _local10 = Vector.<Number>([-0.5, 0.5, 0, 0, 0, 0.5, 0.5, 0, 1, 0, (-0.5 + _local8), -0.5, 0, 0, 1, (0.5 + _local9), -0.5, 0, 1, 1]);
            GraphicsFillExtra.setVertexBuffer(_local13.bitmapFill_, _local10);
        }
    }
    ...
    protected function addBit(_arg1:Vector3D, _arg2:Vector3D, _arg3:Vector3D, _arg4:Vector3D, _arg5:BitmapData, _arg6:Vector3D, _arg7:Boolean, _arg8:Boolean=false, _arg9:Boolean=false):void
    {
        ...
        var _local12:ObjectFace3D = new ObjectFace3D(obj3D_, new <int>[_local11, (_local11 + 1), (_local11 + 2), (_local11 + 3)]);
        _local12.texture_ = _arg5;
        _local12.bitmapFill_.repeat = this.wallRepeat_;
        _local12.normalL_ = _arg6;
        if (((!(Parameters.isGpuRender())) && (!(_arg8))))
        {
            obj3D_.faces_.push(_local12);
        }
        else
        {
            if (_arg8)
            {
                if (_arg9)
                {
                    _local10 = Vector.<Number>([-0.75, 0.5, 0, 0, 0, -0.5, 0.5, 0, 1, 0, -0.75, -0.5, 0, 0, 1, -0.5, -0.5, 0, 1, 1]);
                }
                else
                {
                    _local10 = Vector.<Number>([0.5, 0.5, 0, 0, 0, 0.75, 0.5, 0, 1, 0, 0.5, -0.5, 0, 0, 1, 0.75, -0.5, 0, 1, 1]);
                }
                GraphicsFillExtra.setVertexBuffer(_local12.bitmapFill_, _local10);
                obj3D_.faces_.push(_local12);
            }
        }
    }
    ...
    protected function addTop(_arg1:Array, _arg2:Vector.<Number>, _arg3:BitmapData):void
    {
        ...
        var _local11:int;
        var _local12:int;
        var _local13:int = int((obj3D_.vL_.length / 3));
        var _local14:Vector.<int> = new Vector.<int>();
        var _local15:uint;
        while (_local15 < _arg1.length)
        {
            obj3D_.vL_.push(_arg1[_local15].x, _arg1[_local15].y, _arg1[_local15].z);
            _local14.push((_local13 + _local15));
            if (_local15 == 0)
            {
        ...
        var _local16:ObjectFace3D = new ObjectFace3D(obj3D_, _local14);
        _local16.texture_ = _arg3;
        _local16.bitmapFill_.repeat = this.topRepeat_;
        obj3D_.faces_.push(_local16);
        if (((_local14.length == 6) && (Parameters.isGpuRender())))
        {
            _local4 = new ObjectFace3D(obj3D_, _local14);
            _local4.texture_ = _arg3;
            _local4.bitmapFill_.repeat = this.topRepeat_;
            obj3D_.faces_.push(_local4);
        }
        var _local17:int;
        if ((((_local14.length == 4) && (GraphicsFillExtra.getVertexBuffer(_local16.bitmapFill_) == null)) && (Parameters.isGpuRender())))
        {
            _local5 = new Vector.<Number>();
            _local17 = 0;
            while (_local17 < _local14.length)
            {
                ...
                _local5.push(obj3D_.vL_[(_local14[_local6] * 3)], (obj3D_.vL_[((_local14[_local6] * 3) + 1)] * -1), obj3D_.vL_[((_local14[_local6] * 3) + 2)], obj3D_.uvts_[(_local14[((_local6 != 2) ? _local6 : (_local6 - 1))] * 3)], obj3D_.uvts_[((_local14[((_local6 != 2) ? _local6 : (_local6 + 1))] * 3) + 1)]);
                _local17++;
            }
            GraphicsFillExtra.setVertexBuffer(_local16.bitmapFill_, _local5);
        }
        else
        {
            if ((((_local14.length == 6) && (GraphicsFillExtra.getVertexBuffer(_local16.bitmapFill_) == null)) && (Parameters.isGpuRender())))
            {
                _local7 = [0, 1, 5, 2];
                _local8 = [2, 3, 5, 4];
                _local9 = [5, 0, 2, 1];
                ...
                while (_local10 < 2)
                {
                    ...
                    for each (_local17 in _local7)
                    {
                        ...
                        _local5.push(obj3D_.vL_[(_local14[_local17] * 3)], (obj3D_.vL_[((_local14[_local17] * 3) + 1)] * -1), obj3D_.vL_[((_local14[_local17] * 3) + 2)], obj3D_.uvts_[(_local14[((_local12 != 2) ? _local12 : (_local12 - 1))] * 3)], obj3D_.uvts_[((_local14[((_local12 != 2) ? _local12 : (_local12 + 1))] * 3) + 1)]);
                        _local11++;
                    }
                    if (_local10 == 1)
                    {
                        GraphicsFillExtra.setVertexBuffer(_local4.bitmapFill_, _local5);
                    }
                    else
                    {
                        GraphicsFillExtra.setVertexBuffer(_local16.bitmapFill_, _local5);

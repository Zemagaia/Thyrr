...
public class Merchant extends SellableObject implements IInteractiveObject {
    ...
    public function getSpeechBalloon(_arg1:int):AddSpeechBalloonVO {
        ...
        switch (_arg1) {
            case NEW_MESSAGE:
                _local2 = new LineBuilder().setParams("New!");
                _local3 = 0xE6E6E6;
                _local4 = 0xFFFFFF;
                _local5 = 5931045;
                break;
            case MINS_LEFT_MESSAGE:
                if (this.minsLeft_ == 0) {
                    _local2 = new LineBuilder().setParams("Going soon!");
                }
                else {
                    if (this.minsLeft_ == 1) {
                        _local2 = new LineBuilder().setParams("Going in 1 min!");
                    }
                    else {
                        _local2 = new LineBuilder().setParams("Going in {minutes} mins!", {"minutes": this.minsLeft_});
                    }
                }
                _local3 = 5973542;
                _local4 = 16549442;
            ...
            case ITEMS_LEFT_MESSAGE:
                _local2 = new LineBuilder().setParams("{count} left!", {"count": this.count_});
                _local3 = 5973542;
                _local4 = 16549442;
                _local5 = 16549442;
                break;
            case DISCOUNT_MESSAGE:
                _local2 = new LineBuilder().setParams("{discount}% off!", {"discount": this.discount_});
                _local3 = 6324275;
                _local4 = 16777103;
                _local5 = 16777103;
                break;

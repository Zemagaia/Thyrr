...
public class UnstoppableEffect extends ParticleEffect {

    public var go_:GameObject;
    public var lastPart_:int;

    public function UnstoppableEffect(_arg1:GameObject) {
        this.go_ = _arg1;
        this.lastPart_ = 0;
    }
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        if (_local3 > 500) {
            ...
            _local7 = new HealParticle(0xffdd87, (Math.random() * 0.3), _local5, 1000, (0.1 + (Math.random() * 0.1)), this.go_, _local4, _local6);

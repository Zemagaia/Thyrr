...
public class CreateNewCharacterRect extends CharacterRect {
    ...
    public function CreateNewCharacterRect(_arg1:PlayerModel) {
        var _local2:int;
        super();
        super.className = new LineBuilder().setParams("New Character");
        ...
        if (_arg1.getNumStars() != FameUtil.maxStars()) {
            ...
            super.makeTaglineText(new LineBuilder().setParams("{remainingStars} Class quests not yet completed", {"remainingStars": _local2}));

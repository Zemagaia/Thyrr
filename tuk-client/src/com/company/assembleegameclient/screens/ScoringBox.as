...
public class ScoringBox extends Sprite {
    ...
    public function ScoringBox(_arg1:Rectangle, _arg2:XML) {
        ...
        graphics.lineStyle();
        this.scrollbar_ = new LegacyScrollbar(16, this.rect_.height);
        ...
        this.addLine("Shots", null, 0, _arg2.Shots, false, 5746018);
        if (int(_arg2.Shots) != 0) {
            this.addLine("Accuracy", null, 0, ((100 * Number(_arg2.ShotsThatDamage)) / Number(_arg2.Shots)), true, 5746018, "", "%");
        }
        this.addLine("Tiles Seen", null, 0, _arg2.TilesUncovered, false, 5746018);
        this.addLine("Monster Kills", null, 0, _arg2.MonsterKills, false, 5746018);
        this.addLine("God Kills", null, 0, _arg2.GodKills, false, 5746018);
        this.addLine("Oryx Kills", null, 0, _arg2.OryxKills, false, 5746018);
        this.addLine("Quests Completed", null, 0, _arg2.QuestsCompleted, false, 5746018);
        this.addLine("Dungeons Completed", null, 0, (((((((((((((((((((((((((int(_arg2.PirateCavesCompleted) + int(_arg2.UndeadLairsCompleted)) + int(_arg2.AbyssOfDemonsCompleted)) + int(_arg2.SnakePitsCompleted)) + int(_arg2.SpiderDensCompleted)) + int(_arg2.SpriteWorldsCompleted)) + int(_arg2.TombsCompleted)) + int(_arg2.ForestMazeCompleted)) + int(_arg2.LairOfDraconisCompleted)) + int(_arg2.CandyLandCompleted)) + int(_arg2.HauntedCemeteryCompleted)) + int(_arg2.CaveOfAThousandTreasuresCompleted)) + int(_arg2.MadLabCompleted)) + int(_arg2.DavyJonesCompleted)) + int(_arg2.TombHeroicCompleted)) + int(_arg2.DreamscapeCompleted)) + int(_arg2.IceCaveCompleted)) + int(_arg2.DeadWaterDocksCompleted)) + int(_arg2.CrawlingDepthCompleted)) + int(_arg2.WoodLandCompleted)) + int(_arg2.BattleNexusCompleted)) + int(_arg2.TheShattersCompleted)) + int(_arg2.BelladonnaCompleted)) + int(_arg2.PuppetMasterCompleted)) + int(_arg2.ToxicSewersCompleted)) + int(_arg2.TheHiveCompleted)), false, 5746018);
        this.addLine("Party Member Level Ups", null, 0, _arg2.LevelUpAssists, false, 5746018);
        ...
        this.addLine("Base Fame Earned", null, 0, _arg2.BaseFame, true, 0xFFC800, "", "", new Bitmap(_local3));

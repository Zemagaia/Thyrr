...
public class MapUserInput {
    ...
    private function onKeyDown(_arg1:KeyboardEvent):void {
        ...
        switch (_arg1.keyCode) {
            ...
            case Parameters.data_.useSpecial:
                ...
                break;
            case Parameters.data_.secondAbility:
                _local6 = this.gs_.map.player_;
                if (_local6 == null) break;
                if (!this.specialKey2Down_) {
                    _local7 = this.gs_.map.mouseX;
                    _local8 = this.gs_.map.mouseY;
                    _local9 = _local3.useAltWeapon(_local7, _local8, UseType.START_USE, 2);
                    if (_local9) {
                        this.specialKey2Down_ = true;
                    }
                }
                break;
            ...
            case Parameters.data_.testOne:
                break;
            case Parameters.data_.skillTreeOffensive:
                _local7 = this.gs_.map.mouseX;
                _local8 = this.gs_.map.mouseY;
                _local3.useOffensiveAbility(_local7, _local8);
                break;
            case Parameters.data_.skillTreeDefensive:
                _local7 = this.gs_.map.mouseX;
                _local8 = this.gs_.map.mouseY;
                _local3.useDefensiveAbility(_local7, _local8);
                break;
        }
    ...
    private function onKeyUp(_arg1:KeyboardEvent):void {
        ...
        switch (_arg1.keyCode) {
            ...
            case Parameters.data_.secondAbility:
                if (this.specialKey2Down_) {
                    this.specialKey2Down_ = false;
                    _local2 = this.gs_.map.mouseX;
                    _local3 = this.gs_.map.mouseY;
                    this.gs_.map.player_.useAltWeapon(this.gs_.map.mouseX, this.gs_.map.mouseY, UseType.END_USE, 2);
                }
                break;
        }
        this.setPlayerMovement();
    ...
    private function useItem(slot:int):void {
        ...
        var slotIndex:int =
                ObjectLibrary.getMatchingSlotIndex(this.gs_.map.player_.equipment_[slot].ObjectType, this.gs_.map.player_);
        if (slotIndex != -1) {

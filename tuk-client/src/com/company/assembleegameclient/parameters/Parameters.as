...
public class Parameters {
    ...
    public static const GUILD_CREATION_PRICE:int = 50000;
    ...
    public static const MAPTEST_GAMEID:int = -9;
    ...
    public static const RSA_PUBLIC_KEY:String =
            "-----BEGIN PUBLIC KEY-----\n" +
            "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJYcGYP8085tR3BvhI/PIyG5zsWjCbGF\n" +
            "GIdO8h9zcwWCMQI0rmMfiNXY779YssKiQwrj3PDDsxmw1+V6Qd1uVNkCAwEAAQ==\n" +
            "-----END PUBLIC KEY-----";
    ...
    public static var toggleHPBar_:Boolean = true;
    private static var keyNames_:Dictionary = new Dictionary();


    public static function load():void {
        try {
            savedOptions_ = SharedObject.getLocal("TUKGameOptions", "/");
    ...
    public static function setDefaults():void {
        ...
        setDefaultKey("secondAbility", KeyCodes.C);
        setDefaultKey("interact", KeyCodes.BACKQUOTE);
        ...
        setDefaultKey("escapeToRealm2", KeyCodes.F5);
        setDefaultKey("escapeToRealm", KeyCodes.R);
        ...
        setDefaultKey("togglePerformanceStats", KeyCodes.J);
        setDefaultKey("options", KeyCodes.ESCAPE);
        setDefaultKey("toggleCentering", KeyCodes.F1);
        ...
        setDefault("allowMiniMapRotation", true);
        ...
        setDefault("allyDamage", false);
        setDefault("allyNotifications", true);
        ...
        setDefault("dynamicColor", true);
        setDefault("hpInfo", true);
        setDefault("scaleChat", true);
        setDefault("outlineProj", true);
        setDefault("outlineTooltips", true);
        setDefaultKey("reconVault", KeyCodes.F2);
        setDefaultKey("reconGuild", KeyCodes.F3);
        setDefault("showDamageCounter", true);
        setDefaultKey("skillTreeOffensive", KeyCodes.SHIFT);
        setDefaultKey("skillTreeDefensive", KeyCodes.CONTROL);
    }

...
public class PaymentMethod {
    ...
    public static const GO_METHOD:PaymentMethod = new PaymentMethod("Google Checkout", "co", "");
    public static const PAYPAL_METHOD:PaymentMethod = new PaymentMethod("Paypal", "ps", "P3");
    public static const CREDITS_METHOD:PaymentMethod = new PaymentMethod("Credit Cards, etc.", "ps", "CH");

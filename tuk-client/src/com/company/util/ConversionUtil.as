...
public class ConversionUtil {
    ...
    public static function itemDataFromBase64(string:String):Vector.<ItemData>
    {
        return ConversionUtil.itemDataFromBytes(Base64.decodeToByteArray(string));
    }

    public static function itemDataFromBytes(array:ByteArray):Vector.<ItemData>
    {
        array.endian = "littleEndian";
        var len:int = array.readShort();
        var data:Vector.<ItemData> = new Vector.<ItemData>(len);
        var i:int = 0;
        while (i < len)
        {
            var len2:int = array.readShort();
            var ba:ByteArray = new ByteArray();
            ba.endian = "littleEndian";
            array.readBytes(ba, 0, len2);
            data[i] = new ItemData(ba);
            i++;
        }
    ...
    public static function petDataFromBase64(string:String):PetData
    {
        return new PetData(Base64.decodeToByteArray(string));
    }

    public static function petDataFromBytes(array:ByteArray):Vector.<PetData>
    {
        array.endian = "littleEndian";
        var len:int = array.readShort();
        var data:Vector.<PetData> = new Vector.<PetData>(len);
        var i:int = 0;
        while (i < len)
        {
            var len2:int = array.readShort();
    ...
    public static function questDataFromBytes(array:ByteArray):Vector.<QuestData>
    {
        array.endian = "littleEndian";
        var len:int = array.readShort();
        var data:Vector.<QuestData> = new Vector.<QuestData>(len);
        var i:int = 0;
        while (i < len)
        {
            var len2:int = array.readShort();
    ...
    public static function acceptedQuestDataFromBytes(array:ByteArray):Vector.<AcceptedQuestData>
    {
        array.endian = "littleEndian";
        var len:int = array.readShort();
        var data:Vector.<AcceptedQuestData> = new Vector.<AcceptedQuestData>(len);
        var i:int = 0;
        while (i < len)
        {
            var len2:int = array.readShort();
            ...
            ba.endian = "littleEndian";
            array.readBytes(ba, 0, len2);
            data[i] = new AcceptedQuestData(ba);
            i++;
        }

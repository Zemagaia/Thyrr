...
public class BitmapUtil {
    ...
    public static function cropToBitmapData(data:BitmapData, x:int, y:int, w:int, h:int):BitmapData {
        var bitmapData:BitmapData = new BitmapData(w, h);
        bitmapData.copyPixels(data, new Rectangle(x, y, w, h), new Point(0, 0));
        return (bitmapData);
    }

...
public class PetViewerPanel extends ButtonPanel {

    public function PetViewerPanel(gameSprite:GameSprite) {
        super(gameSprite, "Pets", "View");
    ...
    private function open():void {
        ...
        this.gs_.addChild(new PetViewer(this.gs_.mui_.gs_));
    }

...
public class QuestGiverPanel extends ButtonPanel {

    public function QuestGiverPanel(gameSprite:GameSprite) {
        super(gameSprite, "Quests", "View");
    ...
    private function open():void {
        ...
        this.gs_.addChild(new QuestGiver(this.gs_.mui_.gs_));
    }

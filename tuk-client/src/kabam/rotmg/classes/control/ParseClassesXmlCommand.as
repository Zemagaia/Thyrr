...
public class ParseClassesXmlCommand {
    ...
    private function populateCharacter(_arg1:CharacterClass, _arg2:XML):void {
        ...
        _arg1.strength = this.parseCharacterStat(_arg2, "Strength");
        _arg1.wit = this.parseCharacterStat(_arg2, "Wit");
        _arg1.armor = this.parseCharacterStat(_arg2, "Armor");
        _arg1.agility = this.parseCharacterStat(_arg2, "Agility");
        _arg1.dexterity = this.parseCharacterStat(_arg2, "Dexterity");
        _arg1.stamina = this.parseCharacterStat(_arg2, "Stamina");
        _arg1.intelligence = this.parseCharacterStat(_arg2, "Intelligence");
        _arg1.resistance = this.parseCharacterStat(_arg2, "Resistance");

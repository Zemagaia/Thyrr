...
public class AddTextLine {


    public var chatMessage:ChatMessage;
    public var textStringMap:TextAndMapProvider = Global.textAndMapProvider;
    public var model:ChatModel = Global.chatModel;


    public function execute(msg:ChatMessage):void {
        this.chatMessage = msg;
        this.translateMessage();
        this.translateName();
        this.model.pushMessage(this.chatMessage);
        Global.onAddChat(this.chatMessage);
    }

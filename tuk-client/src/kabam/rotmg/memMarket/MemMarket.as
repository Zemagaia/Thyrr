...
package kabam.rotmg.memMarket
{
    ...
    public class MemMarket extends Sprite 
    {
        ...
        public function MemMarket(gameSprite:GameSprite)
        {
            ...
            graphics.lineStyle();
            this.titleText_ = new BaseSimpleText(36, 0xFFFFFF, false, Main.DefaultWidth, 0);
            ...
            this.closeButton_.x = (((Main.DefaultWidth - 90) / 2) - (this.closeButton_.width / 2));
            this.closeButton_.y = Main.DefaultHeight - 70;

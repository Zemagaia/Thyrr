...
package kabam.rotmg.memMarket
{
    ...
    public class MemMarket extends Sprite 
    {
        ...
        public function MemMarket(gameSprite:GameSprite)
        {
            ...
            graphics.lineStyle();
            this.titleText_ = new BaseSimpleText(36, 0xFFFFFF, false, WebMain.DefaultWidth, 0);
            ...
            this.closeButton_ = new TitleMenuOption("Close", 36, 24);
            this.closeButton_.x = (((WebMain.DefaultWidth - 90) / 2) - (this.closeButton_.width / 2));
            this.closeButton_.y = WebMain.DefaultHeight - 70;

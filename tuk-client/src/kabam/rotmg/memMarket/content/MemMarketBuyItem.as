    ...
    public class MemMarketBuyItem extends MemMarketItem 
    {
        ...
        public function MemMarketBuyItem(gameSprite:GameSprite, data:MarketData)
        {
            ...
            if (this.quality_)
                this.quality_.x += 26;
            this.icon_.y = -8;
            this.buyButton_ = new DeprecatedTextButton(10, "Buy", 96);
            this.buyButton_.x = 2;
        ...
        {
            DialogUtils.makeCallbackDialog(this.gameSprite_, "Verification", "Are you sure that you want to buy this item?", "Yes", "No", this.onVerified);
        }

...
public class MiniMapImp extends MiniMap {
    ...
    private var optionsBtn:ToggleableButton;
    ...
    public function MiniMapImp(w:int, h:int) {
    ...
    private function createOptionsBtn():void {
        optionsBtn = new ToggleableButton(24, 24, 0xAEA9A9, 0x09, false)
        optionsBtn.addEventListener(MouseEvent.CLICK, onOptionsClick);
        this.optionsBtn.x = bgBox.x - optionsBtn.width - 4;
        this.optionsBtn.y = bgBox.y + 6;
        addChild(this.optionsBtn);
        this.optionsBtn.addEventListener(MouseEvent.CLICK, onOptionsClick);
    ...
    private function createGiftBtn():void {
        giftBtn = new HoldableButton(24, 24, 0xAEA9A9, 0x0C, false);
    ...
    private function createMailBtn():void {
        mailBtn = new HoldableButton(24, 24, 0xAEA9A9, 0x0D, false);

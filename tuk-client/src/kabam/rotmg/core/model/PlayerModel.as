...
public class PlayerModel {
    ...
    public const unholyEssenceChanged:Signal = new Signal(int);
    public const divineEssenceChanged:Signal = new Signal(int);
    ...
    public function getUnholyEssence():int {
        return (this.charList.unholyEssence_);
    }

    public function changeUnholyEssence(_arg1:int):void {
        this.charList.unholyEssence_ = (this.charList.unholyEssence_ + _arg1);
        this.unholyEssenceChanged.dispatch(this.charList.unholyEssence_);
    }


    public function setUnholyEssence(_arg1:int):void {
        if (this.charList.unholyEssence_ != _arg1) {
            this.charList.unholyEssence_ = _arg1;
            this.unholyEssenceChanged.dispatch(_arg1);
        }
    }

    public function getDivineEssence():int {
        return (this.charList.divineEssence_);
    }

    public function changeDivineEssence(_arg1:int):void {
        this.charList.divineEssence_ = (this.charList.divineEssence_ + _arg1);
        this.divineEssenceChanged.dispatch(this.charList.divineEssence_);
    }

    public function setDivineEssence(_arg1:int):void {
        if (this.charList.divineEssence_ != _arg1) {
            this.charList.divineEssence_ = _arg1;
            this.divineEssenceChanged.dispatch(_arg1);
        }
    }

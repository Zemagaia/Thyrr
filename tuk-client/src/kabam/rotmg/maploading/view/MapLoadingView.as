...
public class MapLoadingView extends Sprite {
    ...
    private function addBackground():void {
        ...
        bg.graphics.drawRect(0, 0, WebMain.STAGE.stageWidth, WebMain.STAGE.stageHeight);
        bg.graphics.endFill();
        addChild(bg);
    }
    ...
    private function makeLoadingScreen():void {
        ...
        _mapNameField.x = WebMain.DefaultWidth / 2;
        _mapNameField.y = WebMain.DefaultHeight / 2 - 20;

        _mapDifficultyText.setBold(true);
        _mapDifficultyText.setAutoSize(TextFieldAutoSize.CENTER);
        _mapDifficultyText.x = WebMain.DefaultWidth / 2;
        _mapDifficultyText.y = WebMain.DefaultHeight / 2 + 10;
    ...
    private function setValues():void {
        ...
        if (_difficulty > 0)
        {
            ...
            while (i < 5)
            {
                ...
                _indicators[i].x = WebMain.DefaultWidth / 2.2 + 20 * i;
                _indicators[i].y = WebMain.DefaultHeight / 2 + 24;

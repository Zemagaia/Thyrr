...
public class LegendListItem extends Sprite {
    ...
    private function makeInventory():void {
        ...
        this.inventoryGrid.x = WIDTH / 2 - this.inventoryGrid.width / 2.5;
    ...
    private function makeTotalFame():void {
        ...
        this.totalFameText.setAutoSize(TextFieldAutoSize.RIGHT);
        this.totalFameText.x = ((WIDTH - 30) - this.totalFameText.width);

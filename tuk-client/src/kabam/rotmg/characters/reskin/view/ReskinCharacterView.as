...
public class ReskinCharacterView extends Sprite {
    ...
    private function makeTitle():TextFieldDisplayConcrete {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams("Select a Skin"));
    ...
    private function makeCancelButton():DeprecatedTextButton {
        var _local1:DeprecatedTextButton = new DeprecatedTextButton(BUTTON_FONT, "Cancel", BUTTON_WIDTH);
        addChild(_local1);
    ...
    private function makeSelectButton():DeprecatedTextButton {
        var _local1:DeprecatedTextButton = new DeprecatedTextButton(BUTTON_FONT, "Select", BUTTON_WIDTH);
        addChild(_local1);
        this.layoutListener.push(_local1.textChanged);
        return (_local1);
    }

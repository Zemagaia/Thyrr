...
public class MoneyFrame extends Sprite {
    ...
    private static const TITLE:String = "Support the game and buy Realm Gold";//"MoneyFrame.title"
    private static const PAYMENT_SUBTITLE:String = "Payment Method";//"MoneyFrame.payment"
    private static const GOLD_SUBTITLE:String = "Gold Amount";//"MoneyFrame.gold"

...
public class SecurityQuestionsDialog extends Frame {
    ...
    public function SecurityQuestionsDialog(_arg1:Array, _arg2:Array) {
        ...
        super("Set your security questions", "", "Save");
        this.createAssets();
    ...
    public function clearErrors():void {
        ...
        titleText_.setStringBuilder(new LineBuilder().setParams("Set your security questions"));
    ...
    public function displayErrorText():void {
        var _local1:String = (((this.errors.length == 1)) ? this.errors[0] : "Please fix the errors below");

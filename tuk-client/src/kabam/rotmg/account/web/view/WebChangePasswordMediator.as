...
public class WebChangePasswordMediator extends Mediator {
    ...
    private function onChange():void {
        ...
        if (((((this.isCurrentPasswordValid()) && (this.isNewPasswordValid()))) && (this.isNewPasswordVerified()))) {
            ...
            _local1.currentPassword = GameServerConnection.rsaEncrypt(this.view.password_.text());
            _local1.newPassword = GameServerConnection.rsaEncrypt(this.view.newPassword_.text());

...
public class CreditDisplayMediator extends Mediator {
    ...
    private function onCreditsChanged(_arg1:int):void {
        this.view.draw(_arg1, this.model.getFame(), this.model.getUnholyEssence(), this.model.getDivineEssence());
    }

    private function onFameChanged(_arg1:int):void {
        this.view.draw(this.model.getCredits(), _arg1, this.model.getUnholyEssence(), this.model.getDivineEssence());
    }

    private function onUnholyEssenceChanged(_arg1:int):void {
        this.view.draw(this.model.getCredits(), this.model.getFame(), _arg1, this.model.getDivineEssence());
    }

    private function onDivineEssenceChanged(_arg1:int):void {
        this.view.draw(this.model.getCredits(), this.model.getFame(), this.model.getUnholyEssence(), _arg1);
    }

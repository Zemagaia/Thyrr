...
import kabam.rotmg.game.commands.MailUpdateCommand;
...
import kabam.rotmg.game.view.MailDisplayMediator;
...
public class GameConfig implements IConfig {
    ...
    private function generalGameConfiguration():void {
        ...
        this.injector.map(MailModel).asSingleton();
        ...
        this.injector.map(StatView).asSingleton();
        ...
        this.commandMap.map(MailUpdateSignal).toCommand(MailUpdateCommand);
    ...
    private function makeGiftStatusDisplayMappings():void {
        ...
        this.mediatorMap.map(MailDisplay).toMediator(MailDisplayMediator);
    }

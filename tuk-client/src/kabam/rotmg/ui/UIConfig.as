...
import kabam.rotmg.account.core.services.BlankTask;
...
public class UIConfig implements IConfig {
    ...
    public function configure():void {
        ...
        this.injector.map(TabStripSwapTabSignal).asSingleton();
        ...
        this.startup.addTask(BlankTask); // is this even real? why do you need more tasks
        this.startup.addTask(BlankTask);
        this.startup.addTask(BlankTask);

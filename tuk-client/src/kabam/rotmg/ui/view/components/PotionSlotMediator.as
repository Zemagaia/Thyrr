...
public class PotionSlotMediator extends Mediator {
    ...
    private function initializeData(_arg1:Player):void {
        ...
        this.view.setData(_local3, _local2.objectId);
    }
        ...
        if ((((_local3 is Map)) || (((Parameters.isGpuRender()) && ((_local3 == null)))))) {
            ...
            if ((_local3 is InteractiveItemTile)) {
                ...
                if ((((_local4.getItemId() == ItemConstants.NO_ITEM)) && (!((_local4.ownerGrid.owner == _local2))))) {
                    ...
                    data.ObjectType = this.view.objectType;
                    GameServerConnection.instance.invSwapPotion(_local2, _local2, PotionInventoryModel.getPotionSlot(this.view.objectType), data, _local4.ownerGrid.owner, _local4.tileId, ItemConstants.DEFAULT_ITEM);
                }
            }
        }
    }

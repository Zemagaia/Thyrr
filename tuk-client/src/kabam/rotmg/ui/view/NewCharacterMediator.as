...
public class NewCharacterMediator extends Mediator {
    ...
    private function onBuyCharacterPending(_arg1:int):void {
        this.view.updateCreditsAndFame(this.playerModel.getCredits(), this.playerModel.getFame(), this.playerModel.getUnholyEssence(), this.playerModel.getDivineEssence());
    }

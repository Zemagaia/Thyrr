...
public class TermsView extends Sprite {
    ...
    public function TermsView() {
        ...
        this.termsDialog = new Dialog("Terms of Use", "", "No way", "I agree", null);
        ...
        this.termsDialog.setTextParams("Do you agree to the {tou}Terms of Use{_tou}?", {
            "tou": _local_1,
            "_tou": _local_2
        });
    ...
    private function reject(_arg_1:Event):void {
        ...
        this.rejectDialog = new Dialog(null, "Ummm...  Ok.  This is awkward. No hard feelings or anything. We're cool, right?",
                "Yea, we're cool", null, "/noWay");
    ...
    private function onYeaWereCool(_arg_1:Event):void {
        ...
        var _local_2:Dialog = new Dialog(null, "Great.  Peace out.", null, null, "/peaceOut");
        addChild(_local_2);

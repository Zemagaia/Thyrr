...
public class LoadTextureDialog extends Sprite {
    ...
    public function LoadTextureDialog(_arg_1:SearchModel) {
        ...
        this.searchButton_ = new StaticTextButton(16, "Search", 120);
        ...
        this.prevButton_ = new StaticClickableText(16, true, "Previous");
        ...
        this.nextButton_ = new StaticClickableText(16, true, "Next");
    ...
    private function updateSpriteSheetText():void {
        if (this.updateSpriteSheetText_ == null) {
            ...
            this.downloadButton_ = new StaticClickableText(16, true, "Download");
